...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2023 a las 13:43:10
...
INSERT INTO `cliente` (`codigo`, `nombre`, `direccion`, `codigoPostal`, `localizacion`, `provincia`, `email`, `telefono1`, `datosBanco`, `telefono2`, `nota`) VALUES
(1, 'Ramon alvarez', 'calle sdahgsdf hygvdshgaf sdhagfdsag sdjgfsdasdf', 23700, 'linares', 'jaen', 'sdhugsdaf@gmail.com', '619457615', '45647981654654', 953124512, 'fgdjtdrtjdjrtdtujdcrtd'),
(2, 'Pepe benito', 'calle nasduigsduygsdfsdafsdfsdasd', 21011, 'linares', 'jaen', 'lhigsauidg@gmail.com', '619456123', '45647981654654', 953124512, 'asdgyfsduhgf hgsdahifasd bhdsajlfsd dghsafjds hsdjaklf dsdsafjkdlsha dsjfakgf');
